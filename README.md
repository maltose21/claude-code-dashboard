...
| **Harness 架构** | 按 6 个维度（输入/知识/执行/集成/多智能体/可观测）可视化展示当前配置，生成能力画像 |
...
- **Harness Architecture** — Visualize your config across 6 dimensions (Input → Knowledge → Execution → Integration → Multi-Agent → Observability), with auto-generated capability profile
